...
TEST(format, float)
{
    ...
    EXPECT_GE(chsnprintf(test, sizeof(test), "%f", 0.999f), 0);
    EXPECT_STREQ("0.999000", test);

    EXPECT_GE(chsnprintf(test, sizeof(test), "%.4f", 0.999f), 0);
    EXPECT_STREQ("0.9990", test);

    EXPECT_GE(chsnprintf(test, sizeof(test), "%.3f", 0.999f), 0);
    ...
    EXPECT_GE(chsnprintf(test, sizeof(test), "%.2f", 0.999f), 0);
