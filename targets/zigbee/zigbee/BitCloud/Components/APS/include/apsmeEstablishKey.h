/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: apsmeEstablishKey.h 17448 2011-06-09 13:53:59Z ataradov $
 ******************************************************************************/
...
/**************************************************************************//**
  \brief Initiates the key-establishment procedure
   ...
   One device initiates the procedure, and the other device acts
   as the responder. The initiator starts the key-establishment procedure
   by calling this function with parameters indicating:
     \li the address of the responder device
     \li key-establishment protocol to use (currently SKKE)
...
#endif /* _USE_SKKE_ */
#endif /* _SECURITY_ and _HIGH_SECURITY_ */
