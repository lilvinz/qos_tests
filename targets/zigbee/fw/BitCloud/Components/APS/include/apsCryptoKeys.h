/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: apsCryptoKeys.h 17657 2011-06-22 13:20:51Z arazinkov $
 ******************************************************************************/
...
/**************************************************************************//**
  ...
  The function shall be called to specify for the stack
  the trust center link key before performing network start if the high security mode is used
  with ::CS_ZDO_SECURITY_STATUS set to 1. If the trust center link key is unavailable
  ::CS_ZDO_SECURITY_STATUS can be set to 2; in this case a master key is used to authenticate
  ...
  needed. If it is known to the application it shall be set with the use of this function. Otherwise,
  the application shall either apply a master key to launch link key establishment procedure
  with the partner node or request for a link key from the trust center.

  A typical example of using the function is given below:
\code
...
/**************************************************************************//**
  ...
  link key establishment with the remote device with the corresponding extended address.

  The function is used when the high security mode is applied to secure network operation.
  ...
  center via this function as well.
  ...
  communicate before sending any data requests to it. In this case the stack launches link key
  establishment procedure emplying the specified master key.
