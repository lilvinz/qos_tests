...
#define FLASH_ZIGBEE_FW_BASE        	0x700000
#define FLASH_ZIGBEE_FW_SIZE        	0x40000  // 256 kbytes
#define FLASH_ZIGBEE_FW_END         	(FLASH_ZIGBEE_FW_BASE + FLASH_ZIGBEE_FW_SIZE - 1)
