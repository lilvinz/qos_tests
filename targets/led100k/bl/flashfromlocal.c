...
const char FFL_ERASING_FLASH[] = "\r\nErasing flash.\r\n";
const char FFL_INSTALLING_FIRMWARE[] = "\r\nInstalling firmware.\r\n";
const char FFL_PLEASE_WAIT[] = "Please wait!\r\n";
const char FFL_WRONG_HW_ID[] = "\nError! Wrong Hardware ID!\r\n";
const char FFL_WRONG_HW_REVISION[] = "\nError! Wrong Hardware revision!\r\n";
