...
volatile unsigned long ulRunTimeCount;
...
void vTraceQueueCreateFailed(void)//unsigned char ucQueueType)
{
...
/*
 * ToDo : fix this piece of ****. Locking will hang, unlocking hard to implement with current OpenOCD
 *
