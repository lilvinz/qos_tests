...
#define FRAM_MESH_FW_UPDATE_RETRIES           0x025  // 1 byte
...
#define FRAM_PSU_SERIAL 0x05E  // 4 byte

// Memory used to store led fail information
#define FRAM_LED_FAIL_FLAGS_START       0x062  // Start of section for led fail flags
#define FRAM_LED_FAIL_FLAGS_BM_MAIN     0x062  // Fail flags for led stages on main board
#define FRAM_LED_FAIL_FLAGS_BM_SLAVE_1  0x064  // Fail flags for led stages on slave board 1
#define FRAM_LED_FAIL_FLAGS_BM_SLAVE_2  0x066  // Fail flags for led stages on slave board 2
#define FRAM_LED_FAIL_FLAGS_NEXT_FREE   0x068  // Please leave enough space for expansion
