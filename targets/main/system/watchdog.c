...
{
//Value: Init, Reload
    { 200, 200 },    // WATCHDOG_TASK_ID_LOG, watchdog task can be blocked by erasing large sections of external flash
    {  60,  60 },    // WATCHDOG_TASK_ID_DRIVER
    {  60,  60 },    // WATCHDOG_TASK_ID_TIMER
    {  60,  60 },    // WATCHDOG_TASK_ID_SENSORS
    {  60,  60 },    // WATCHDOG_TASK_ID_GPSSYNC
    {  60,  60 },    // WATCHDOG_TASK_ID_GLOOM_MANAGER
    {  60,  60 },    // WATCHDOG_TASK_ID_DETECTOR
    {  60,  60 },    // WATCHDOG_TASK_ID_INDICATION
    {  60,  60 },    // WATCHDOG_TASK_ID_MESH
    {  60,  60 },    // WATCHDOG_TASK_ID_SYNDICATION
    {  60,  60 },    // WATCHDOG_TASK_ID_DIM
    {  60,  60 },    // WATCHDOG_TASK_ID_SEQUENCE
    {  60,  60 },    // WATCHDOG_TASK_ID_ALARM_CLOCK
    {  60,  60 },    // WATCHDOG_TASK_ID_SVINFO_MANAGER
#ifdef HWP_CAN_MASTER
    {  60,  60 },    // WATCHDOG_TASK_ID_CAN_MANAGER
#endif
};

static int32_t watchdog_ctr[WATCHDOG_TASK_ID_COUNT];
static int32_t watchdog_heartbeat_ctr[WATCHDOG_TASK_ID_COUNT];
static xQueueHandle xQueueWatchdog;
...
//    kill = (uint32_t*) 0x0;
    ...
    xQueueWatchdog = xQueueCreate(WATCHDOG_QUEUE_SIZE, sizeof(uint8_t));

    assert_param(xQueueWatchdog != NULL);
    ...
    while (1)
    {
        ...
        for (uint8_t i_ctr = 0; i_ctr < WATCHDOG_TASK_ID_COUNT; i_ctr++)
        {
            ...
            {
                LOG(LOG_ID_SYSTEM_WATCHDOG_TASK_TIMEOUT, i_ctr, 0, 0, NULL);
