...
static const char BOOT_MESSAGE_1[] = "\xaa\x55\x1b[2J\r\nBootbase %u.%u"ESC_BOLD ESC_COLOR_RED" *DEBUG* "ESC_ATTRIBUTE_OFF"(" __DATE__ " " __TIME__")\r\n"
                                     "(c) 2013 Quantec Networks GmbH\r\n\r\n";
#else
static const char BOOT_MESSAGE_1[] = "\xaa\x55\x1b[2J\r\nBootbase %u.%u (" __DATE__ " " __TIME__")\r\n"
                                     "(c) 2013 Quantec Networks GmbH\r\n\r\n";
#endif

static const char BOOT_MESSAGE_2[] = "Hardware-ID: 0x%04X\r\nHardware revision: 0x%04X\r\n";
static const char INFO_MSG_OK[] = "\r\n\r\nCheck ok. Starting Firmware!\r\n\r\n";
static const char INFO_MSG_NOK[] = "\r\n\r\nFirmware check failed!\r\n\r\n";
static const char CLEAR_SCREEN_MAIN[] = " \033[;H\033[2J";
