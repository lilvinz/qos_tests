...
//-----------------------------------------------
  ...
  #define APP_SPI_CHANNEL SPI_CHANNEL_1
...
//-----------------------------------------------
  ...
  // communication. Valid channel page numbers are:
...
// topology.
#define CS_MAX_CHILDREN_AMOUNT 40
...
#define CS_MAX_CHILDREN_ROUTER_AMOUNT 20
...
#define CS_END_DEVICE_SLEEP_PERIOD 10
...
//-----------------------------------------------
  ...
  // purposes, the parameter can be assigned to the universal trust center address
  // which equals APS_SM_UNIVERSAL_TRUST_CENTER_EXT_ADDRESS.
  #define CS_APS_TRUST_CENTER_ADDRESS APS_SM_UNIVERSAL_TRUST_CENTER_EXT_ADDRESS
  ...
  // before the timeout exceeds, the device will fail joining the network. A value is
  // measured in milliseconds.
  #define CS_APS_SECURITY_TIMEOUT_PERIOD 30000
...
// discovered.
#define CS_ROUTE_TABLE_SIZE 100
...
#define CS_ADDRESS_MAP_TABLE_SIZE 80
...
#define CS_ROUTE_DISCOVERY_TABLE_SIZE 80
...
// not less than 1.
#define CS_DUPLICATE_REJECTION_TABLE_SIZE 48
...
// released.
#define CS_APS_DATA_REQ_BUFFERS_AMOUNT 20
...
#define CS_APS_ACK_FRAME_BUFFERS_AMOUNT 20

// Amount of buffers to keep MAC data indications on network layer.
#define CS_NWK_BUFFERS_AMOUNT 40
