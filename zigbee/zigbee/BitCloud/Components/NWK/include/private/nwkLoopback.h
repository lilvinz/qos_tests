/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: nwkLoopback.h 17448 2011-06-09 13:53:59Z ataradov $
 ******************************************************************************/
...
/**************************************************************************//**
  \brief Checks, if outgoing multicast packet should be indicated to
    the next higher layer

  \param[in] req - pointer to NLDE-DATA.request parameter's structure.
  \return True, if indication required, false - otherwise
 ******************************************************************************/
NWK_PRIVATE bool nwkMulticastLoopbackRequired(const NWK_DataReq_t *const req);
