/**************************************************************************//**
  ...
  \internal
   ...
   Last change:
    $Id: apsmeRequestKey.h 17470 2011-06-10 11:31:00Z mgekk $
 ******************************************************************************/
 ...
 ******************************************************************************/
/**************************************************************************//**
  \brief Request either the active network key or a new end-to-end app key.
...
/**************************************************************************//**
  ...
  \param[in] ind - pointer to APSME-REQUEST-KEY.indication's parameters.
                   \sa APS_RequestKeyInd_t
  \return None.
 ******************************************************************************/
void APS_RequestKeyInd(APS_RequestKeyInd_t *ind);
