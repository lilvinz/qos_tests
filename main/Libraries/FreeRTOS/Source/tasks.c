 ...
 */
	...
	#define tskSIZE_OF_EACH_TRACE_LINE			( ( unsigned long ) ( sizeof( portTickType ) + sizeof( unsigned long ) ) )
		...
		{																							\
			...
			{																						\
				...
				{																					\
					...
					*( portTickType * ) pcTraceBuffer = ( portTickType ) xTickCount;				\
					pcTraceBuffer += sizeof( portTickType );										\
